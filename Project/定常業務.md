...
最終更新: 2026-03-01（日報未記入リマインドフロー実装）
...
- **Looker Studio の Google ログインが切れています** → Mac Mini の Chrome で Looker Studio に再ログイン。元々 `kohara.kaito@team.addness.co.jp` でのアクセスが必要だったが、`koa800sea.nifs@gmail.com` にも閲覧権限を付与済み。
