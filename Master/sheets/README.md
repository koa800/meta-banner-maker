...
| `1dSIXBovs-c8wVnBWsOqbe2wdqmJQ10bOIWhKJbC1MPw` | 【アドネス株式会社】共通除外マスタ | [リンク](https://docs.google.com/spreadsheets/d/1dSIXBovs-c8wVnBWsOqbe2wdqmJQ10bOIWhKJbC1MPw/edit) | 共通除外の正本。`除外リスト / データソース管理 / データ追加ルール` を持ち、集客・個別予約・決済などの共通除外に使う。初期データは `【アドネス株式会社】顧客データ（複数イベント） / 除外リスト` から移行済み | `python3 System/common_exclusion_master_setup.py` で再生成 |
