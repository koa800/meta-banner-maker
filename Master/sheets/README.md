...
| `1dSIXBovs-c8wVnBWsOqbe2wdqmJQ10bOIWhKJbC1MPw` | 【アドネス株式会社】共通除外マスタ | [リンク](https://docs.google.com/spreadsheets/d/1dSIXBovs-c8wVnBWsOqbe2wdqmJQ10bOIWhKJbC1MPw/edit) | 共通除外の正本。`除外リスト / データソース管理 / データ追加ルール` を持ち、集客・個別予約・決済などの新規データだけを共通除外する。候補元は `支払管理表 / 全メンバーリスト`、正本はこのシートの `除外リスト` | `python3 System/common_exclusion_master_setup.py` で再生成 |
