...
- `Catch Hook -> Mailchimp Add/Update Subscriber` を exploratory に `Create -> Test -> Delete Zap` まで通す本数
- `trigger 1 + action 2` の最小複雑 pattern を live で積むこと
...
- exploratory に `Create Zap` を開いた後、assets 一覧に `Untitled Zap` が残ることがある
