...
この再採点の理由
- Lステップ
  - 単体 Flex の作成とテスト送信は最終的に成功した
  - `フレックスメッセージ` の作成、画像追加、テスト送信、削除、タグ作成削除、流入経路作成削除の exact 手順は取れた
  - ただし入口の切り分け、セッション差、正しいクリック対象の特定で探索コストが出た
- UTAGE
...
- Zapier
  - relay family は読める
  - ただし representative の厚みと例外時の判断辞書はまだ増やせる
