...
def build_definition_rows() -> List[List[str]]:
    return [
        ...
        ["オプトイン数", "メールアドレス登録人数"],
        ["リストイン数", "LINE登録数"],
        ["個別予約数", "【アドネス】顧客管理シート / 個別予約集計botログ に記録された、キャンセルではない個別予約イベント数"],
        ["個別予約数（UU）", "将来接続。個別予約したユニークユーザー数"],
...
def build_summary_rows() -> List[List[str]]:
    ...
    visible_rows = [
        ...
        ["個別予約数", '=IF(OR($B$2="",$B$3=""),"",IF(COUNTIFS(\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3,\'日別数値\'!D:D,"<>")=0,"",SUMIFS(\'日別数値\'!D:D,\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)))', "", "未接続", "期間内合計"],
        ["個別予約数（UU）", '=IF(OR($B$2="",$B$3=""),"",IF(COUNTIFS(\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3,\'日別数値\'!E:E,"<>")=0,"",SUMIFS(\'日別数値\'!E:E,\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)))', "", "未接続", "期間内合計"],
        ["個別実施数", '=IF(OR($B$2="",$B$3=""),"",IF(COUNTIFS(\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3,\'日別数値\'!F:F,"<>")=0,"",SUMIFS(\'日別数値\'!F:F,\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)))', "", "未接続", "期間内合計"],
        ["着金売上", '=IF(OR($B$2="",$B$3=""),"",IF(COUNTIFS(\'日別数値\'!G:G,"<>",\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)=0,"",SUMIFS(\'日別数値\'!G:G,\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)))', "", "未接続", "期間内合計"],
        ["広告費", '=IF(OR($B$2="",$B$3=""),"",IF(COUNTIFS(\'日別数値\'!H:H,"<>",\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)=0,"",SUMIFS(\'日別数値\'!H:H,\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)))', "", "未接続", "期間内合計"],
        ...
        ["会員数", '=IF(OR($B$2="",$B$3=""),"",IFERROR(INDEX(FILTER(\'日別数値\'!L:L,\'日別数値\'!A:A>=$B$2,\'日別数値\'!A:A<=$B$3,\'日別数値\'!L:L<>""),ROWS(FILTER(\'日別数値\'!L:L,\'日別数値\'!A:A>=$B$2,\'日別数値\'!A:A<=$B$3,\'日別数値\'!L:L<>""))),""))', "", "未接続", "期間内の最新値"],
        ["中途解約数", '=IF(OR($B$2="",$B$3=""),"",IF(COUNTIFS(\'日別数値\'!M:M,"<>",\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)=0,"",SUMIFS(\'日別数値\'!M:M,\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)))', "", "未接続", "期間内合計"],
        ["クーリングオフ数", '=IF(OR($B$2="",$B$3=""),"",IF(COUNTIFS(\'日別数値\'!N:N,"<>",\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)=0,"",SUMIFS(\'日別数値\'!N:N,\'日別数値\'!A:A,">="&$B$2,\'日別数値\'!A:A,"<="&$B$3)))', "", "未接続", "期間内合計"],
    ]
