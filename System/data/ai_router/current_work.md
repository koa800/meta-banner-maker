...
- `【アドネス株式会社】決済データ（加工）` を新設済み
  ...
  - `継続売上` は、会員向け商品の成功売上、2回目以降の定期課金、既存会員向けの追加販売を集計する
  ...
  - 2026-03-20 14:41 時点の state:
    - 累計新規着金売上 `3,985,209,792`
    - 累計継続売上 `41,734,874`
    - 累計着金売上 `4,026,944,666`
    - 累計返金額 `798,907,709`
    - 累計純着金売上 `3,228,036,957`
    - 累計解約請求額 `75,218,484`
    - 完全不明金額 `1,858,488,772`
    - 完全不明件数 `25,263`
    - 補完返金件数 `4,299`
    - 新規着金件数 `117,669`
    - 継続売上件数 `3,176`
