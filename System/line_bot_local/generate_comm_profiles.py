...
STYLE_BY_CATEGORY = {
    ...
    "直下メンバー": {
        "formality": "low",
        "greeting": "お疲れ様！",
        "style": "かなりフランク。敬語なし or 最低限。テンポよく短く。感嘆符・強調多め。温度感と情熱を忘れない。",
        "tone_keywords": ["フランク", "テンポよく", "感嘆符多め", "情熱的"],
        "avoid": ["冷たい事務的な返し", "距離感のある敬語"],
    },
    "メンバー": {
        "formality": "low",
        "greeting": "お疲れ様！",
        "style": "かなりフランク。敬語なし or 最低限。テンポよく短く。感嘆符・強調多め。",
        "tone_keywords": ["フランク", "テンポよく", "感嘆符多め"],
        "avoid": ["冷たい事務的な返し", "距離感のある敬語"],
    },
    "外部パートナー": {
