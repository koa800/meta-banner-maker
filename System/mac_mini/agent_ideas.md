...
- [x] **アフィリエイト用コンテンツ自動整備提案**: 成約率が低いアフィリエイターへの支援コンテンツを自動生成（`weekly_affiliate_ideas`・毎週金曜10:00）
...
- [ ] **L-step開封率・反応率週次サマリー**
- [x] **競合比較エージェント**: スキルプラスvs競合3-5社の価格・訴求の差分を月1でまとめる（`monthly_competitor_analysis`・毎月1日10:00）
...
- **weekly_affiliate_ideas**: 毎週金曜10:00にアフィリエイターサポートコンテンツ案をClaude生成してLINE通知
