...
def build_source_rows(stats: Dict[str, object], notification_stats: Dict[str, str]) -> List[List[str]]:
    ...
    return [
        ...
        [
            ...
            "Slack通知",
            "1",
            f'=HYPERLINK("https://docs.google.com/spreadsheets/d/{COLLECTION_SHEET_ID}/edit","【アドネス株式会社】個別面談データ（収集）")',
        ...
        [
            ...
            "【アドネス株式会社】共通除外マスタ",
            "2",
            '=HYPERLINK("https://docs.google.com/spreadsheets/d/1dSIXBovs-c8wVnBWsOqbe2wdqmJQ10bOIWhKJbC1MPw/edit","【アドネス株式会社】共通除外マスタ")',
            "除外リスト / 無条件除外ルール",
            "メールアドレス / 電話番号 / 対象者名",
